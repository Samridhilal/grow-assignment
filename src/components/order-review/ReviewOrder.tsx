...
import { RefreshCcw } from 'lucide-react'; // Assuming RefreshCcw is imported from react-feather
...
const ReviewOrder = (props: Props) => {
    ...
    const { data, isError, isLoading, error, refetch } = useOrderDetails(); // assuming refetch is available from useOrderDetails
    // console.log(data);
