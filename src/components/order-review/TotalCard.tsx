...
const TotalCard = ({ data }: Props) => {
    ...
    return (
        <div className="flex flex-col items-center text-white dark:text-inherit dark:bg-transparent justify-between bg-gray-700 w-full md:w-[40%] rounded-lg p-5 min-h-[370px] relative top-0 dark:border">
